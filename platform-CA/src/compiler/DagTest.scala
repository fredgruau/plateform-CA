 ...
 */
   class Node(  neighbors : => List[Node],val name:String) extends Dag{
     def neighbor=neighbors; override def toString=name;
   ...
   def testGetGreater=  assertEquals(Dag.getGreater( Set(n3)), Set(n1,n2,n3)) 
